...
#ifndef id47D7FEB69F0144E1AC047F44BA3D7DE7
#define id47D7FEB69F0144E1AC047F44BA3D7DE7
...
namespace dindb {
	class BackendSQLite : public Backend {
	public:
		BackendSQLite (BackendSQLite&&) = default;
		BackendSQLite (std::string&& parPath, bool parReadOnly, bool parConnectNow);
		virtual ~BackendSQLite ( void );
